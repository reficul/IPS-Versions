...
class _themes extends \IPS\versions\Versions\Controller
{
    ...
    public function track()
    {
        ...
        $themeIds = array_map( function( $themeVersion ) {
        ...
        $form->add( new \IPS\Helpers\Form\Select( 'versions_theme_select', NULL, TRUE, array( 'options' => $selectThemes ) ) );
        ...
        if ( $values = $form->values() )
        {
            ...
            \IPS\Output::i()->redirect(
                ...
                \IPS\Member::loggedIn()->language()->addToStack( 'versions_track_successful', TRUE,
                    array( 'sprintf' => array( $themeVersion->theme_name ) ) ), 302 );
        }
