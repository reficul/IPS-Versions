...
class _plugins extends \IPS\versions\Versions\Controller
{
    ...
    public function track()
    {
        ...
        $plugIds = array_map( function( $plugVersion ) {
        ...
        $form->add( new \IPS\Helpers\Form\Select( 'versions_plugin_select', NULL, TRUE, array( 'options' => $selectPlugs ) ) );
        ...
        if ( $values = $form->values() )
        {
            ...
            \IPS\Output::i()->redirect(
                ...
                \IPS\Member::loggedIn()->language()->addToStack( 'versions_track_successful', TRUE,
                    array( 'sprintf' => array( $plugVersion->plugin_name ) ) ), 302 );
        }
